...
**Catalog my Things** is an app that stores and displays your movies, games, music, and books.
...
- **You store your movies, books, games, and music**
- **You can list your movies, books, games, and music**
...
```
git clone https://github.com/TaiwoEnoch/Ruby_capstone.git
```
### Install
...
- Stay tuned! we'll keep you posted for any future features
...
If you like this project please leave it a star.
